...
from .types import ICompetitor, IExecutionConnection, Instrument, Lifespan, Side
...
class Competitor(ICompetitor, IOrderListener):
    ...
    def on_order_filled(self, now: float, order: Order, price: int, volume: int, fee: int) -> None:
        ...
        last_traded = self.future_book.last_traded_price() or self.future_book.midpoint_price()
