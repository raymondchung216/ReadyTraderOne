...
from ready_trader_one.types import Instrument

from ready_trader_one.hud.table_gadget import BasicPriceLadderGadget, PerTeamTableGadget, ProfitLossTableGadget
from ready_trader_one.hud.table_model import (ActiveOrderTableModel, BasicPriceLadderModel,
                                              ProfitLossTableModel, TradeHistoryTableModel, PriceLadderModel,
                                              TeamLadderVolumes)
from ready_trader_one.hud.event_source import EventSource
from ready_trader_one.hud.chart import MidpointChartGadget, ProfitLossChartGadget
...
class MainWindow(Ui_main_window, QtWidgets.QMainWindow):
    """Main window for the Ready Trader One heads-up display."""
    ...
    def __init__(self, icon: QtGui.QIcon, event_source: EventSource, parent: Optional[QtWidgets.QWidget] = None):
        ...
        self.setWindowTitle("Ready Trader One")
    ...
    def __on_match_over(self) -> None:
        """Callback when the Ready Trader One match is over."""
    ...
    def __show_all_teams_profit_table(self) -> None:
        ...
        self.__show_sub_window(self.__pnl, self.__on_all_teams_profit_table_closed, 0.45, 0.4)
    ...
    def __show_etf_dynamic_depth(self) -> None:
        ...
        if self.__selected_team and self.__selected_tam in self.__team_volumes:
            self.__etf_ladder.setWindowTitle("ETF (%s)" % self.__selected_team)
        self.__show_sub_window(self.__etf_ladder, self.__on_etf_dynamic_depth_closed, 0.3, 0.4)
    ...
    def __show_future_dynamic_depth(self) -> None:
        ...
        self.__show_sub_window(self.__future_ladder, self.__on_future_dynamic_depth_closed, 0.25, 0.4)
