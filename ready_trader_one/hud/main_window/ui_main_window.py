...
class Ui_main_window(object):
    def setupUi(self, main_window):
        ...
        self.action_About_Ready_Trader_One_Client = QAction(main_window)
        self.action_About_Ready_Trader_One_Client.setObjectName(u"action_About_Ready_Trader_One_Client")
    ...
    def retranslateUi(self, main_window):
        main_window.setWindowTitle(QCoreApplication.translate("main_window", u"Ready Trader One", None))
        ...
        self.action_About_Ready_Trader_One_Client.setText(QCoreApplication.translate("main_window", u"&About Ready Trader One Client", None))
